...
| 기능 | 설명 |
|------|------|
| **56개 노드** | 시세 조회, 펀더멘털 분석, 조건 분기, 주문, 리스크 관리, 차트 시각화까지 |
| **55개 전략 플러그인** | RSI, MACD, 볼린저밴드, 이치모쿠, VWAP, 듀얼모멘텀, 상관분석, 레짐감지, Z-Score, 스퀴즈모멘텀, 모멘텀순위, 시장내부지표, 페어트레이딩, 켈리기준, 리스크패리티, VaR/CVaR, 동적손절 등 바로 쓸 수 있는 전략 |
