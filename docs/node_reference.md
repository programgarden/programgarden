...
| `market` | 13 | 시세/종목/펀더멘털 | MarketDataNode, FundamentalNode, HistoricalDataNode, RealMarketDataNode, WatchlistNode, ScreenerNode, SymbolFilterNode |
...
- [종목조건 플러그인](strategies/stock_condition.md) - RSI, MACD 등 34개 전략 플러그인
