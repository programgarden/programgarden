...
* [ProgramGarden 소개](README.md)
* [빠른 시작 가이드](non_dev_quick_guide.md)

## 워크플로우 기초

* [워크플로우 구조 이해](structure.md)
...
* [종목조건 플러그인](strategies/stock_condition.md)
* [주문 플러그인](strategies/order_condition.md)
