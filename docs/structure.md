...
| `market` | 시세, 종목, 과거 데이터, 펀더멘털, 환율, 심리, 변동성 | WatchlistNode, MarketDataNode, FundamentalNode, HistoricalDataNode, RealMarketDataNode, ScreenerNode, CurrencyRateNode, FearGreedIndexNode, VIXDataNode |
