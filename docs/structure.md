...
| `market` | 시세, 종목 목록, 과거 데이터, 펀더멘털 | WatchlistNode, MarketDataNode, FundamentalNode, HistoricalDataNode, RealMarketDataNode, ScreenerNode |
...
- [종목조건 플러그인](strategies/stock_condition.md) - RSI, MACD 등 48개 분석 전략
