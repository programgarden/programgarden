        ...
        },
        {
            ...
            "workflow_snippet": {
                ...
                "nodes": [
                    ...
                    {"id": "historical", "type": "OverseasStockHistoricalDataNode", "symbol": "{{ item }}", "interval": "1d", "start_date": "20260101", "end_date": "20260401"},
        ...
        },
        {
            ...
            "workflow_snippet": {
                ...
                "nodes": [
                    ...
                    {"id": "historical", "type": "OverseasStockHistoricalDataNode", "symbol": "{{ item }}", "interval": "1d", "start_date": "20250401", "end_date": "20260401"},
        ...
        },
        {
            ...
            "workflow_snippet": {
                ...
                "nodes": [
                    ...
                    {"id": "watchlist", "type": "WatchlistNode", "symbols": [{"symbol": "AAPL", "exchange": "NASDAQ"}]},
                    {"id": "historical", "type": "OverseasStockHistoricalDataNode", "symbol": "{{ item }}", "interval": "1d", "start_date": "20260101", "end_date": "20260401"},
                    {"id": "condition", "type": "ConditionNode", "plugin": "RSI", "items": {"from": "{{ item.time_series }}", "extract": {"symbol": "{{ item.symbol }}", "exchange": "{{ item.exchange }}", "date": "{{ row.date }}", "open": "{{ row.open }}", "high": "{{ row.high }}", "low": "{{ row.low }}", "close": "{{ row.close }}", "volume": "{{ row.volume }}"}}, "fields": {"period": 14, "threshold": 30, "direction": "below"}},
                    {
                        "id": "chart",
                        "type": "CandlestickChartNode",
