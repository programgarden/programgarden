        ...
        },
        {
            ...
            "workflow_snippet": {
                ...
                "nodes": [
                    ...
                    {"id": "modify", "type": "OverseasStockModifyOrderNode",
                     "original_order_id": "{{ nodes.real_event.accepted.order_id }}",
                     "symbol": "{{ nodes.real_event.accepted.symbol }}",
                     "exchange": "{{ nodes.real_event.accepted.exchange }}",
                     "new_quantity": 5},
                ],
                "edges": [
                    {"from": "start", "to": "broker"},
            ...
            "workflow_snippet": {
                ...
                "nodes": [
                    ...
                    {"id": "condition", "type": "ConditionNode", "plugin": "RSI",
                     ...
                     "fields": {"period": 14, "oversold_threshold": 30}},
                    {"id": "sizing", "type": "PositionSizingNode",
