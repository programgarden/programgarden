                ...
                object_schema=[
                    {
                        ...
                        "help_text": "Specify the array to iterate. Access each item via 'row'.",
                    },
                    {
                        "name": "extract",
                        "type": "OBJECT",
                        ...
                        "help_text": "Define the fields to extract from each row. Access current row fields via row.xxx.",
                        "object_schema": [
                            {"name": "symbol", "type": "STRING", "expression_mode": "both", "required": True,
                             "description": "Symbol code", "placeholder": "{{ nodes.split.item.symbol }}"},
                            {"name": "exchange", "type": "STRING", "expression_mode": "both", "required": True,
                             "description": "Exchange code", "placeholder": "{{ nodes.split.item.exchange }}"},
                            {"name": "date", "type": "STRING", "expression_mode": "both", "required": True,
                             "description": "Date", "placeholder": "{{ row.date }}"},
                            {"name": "open", "type": "STRING", "expression_mode": "both", "required": True,
                             "description": "Open price", "placeholder": "{{ row.open }}"},
                            {"name": "high", "type": "STRING", "expression_mode": "both", "required": True,
                             "description": "High price", "placeholder": "{{ row.high }}"},
                            {"name": "low", "type": "STRING", "expression_mode": "both", "required": True,
                             "description": "Low price", "placeholder": "{{ row.low }}"},
                            {"name": "close", "type": "STRING", "expression_mode": "both", "required": True,
                             "description": "Close price", "placeholder": "{{ row.close }}"},
                            {"name": "volume", "type": "STRING", "expression_mode": "both", "required": False,
                             "description": "Volume", "placeholder": "{{ row.volume }}"},
                            {"name": "signal", "type": "STRING", "expression_mode": "both", "required": False,
                             "description": "Trade signal", "placeholder": "{{ nodes.condition.result.signal }}"},
                            {"name": "side", "type": "STRING", "expression_mode": "both", "required": False,
                             "description": "Position side", "placeholder": "{{ nodes.condition.result.side }}"},
                        ],
                    },
                ],
                example={
