...
def get_workflow():
    return {
        ...
        "edges": [
            {"from": "start", "to": "weeklySchedule"},
            {"from": "weeklySchedule", "to": "watchlist"},
            {"from": "weeklySchedule", "to": "historicalData"},
            ...
            {"from": "rsi", "to": "backtest"},
            {"from": "historicalData", "to": "backtest"},
            {"from": "backtest", "to": "performanceCheck"},
            {"from": "performanceCheck", "to": "performanceOkAlert"},
            {"from": "performanceCheck", "to": "pauseJob"},
            {"from": "pauseJob", "to": "pauseAlert"},
            {"from": "backtest", "to": "weeklyReport"},
        ],
    }
