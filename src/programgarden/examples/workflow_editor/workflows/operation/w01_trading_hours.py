...
def get_workflow():
    return {
        ...
        "nodes": [
            ...
            {"id": "watchlist", "type": "WatchlistNode", "category": "symbol", "symbols": [{"exchange": "NASDAQ", "symbol": "AAPL"}], "position": {"x": 800, "y": 200}},
        ...
        "edges": [
            ...
            {"from": "schedule", "to": "hoursFilter"},
            {"from": "schedule", "to": "exchangeStatus"},
            {"from": "hoursFilter", "to": "watchlist"},
            {"from": "exchangeStatus", "to": "watchlist"},
