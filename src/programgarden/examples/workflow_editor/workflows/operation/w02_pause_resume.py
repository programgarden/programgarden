...
def get_workflow():
    return {
        ...
        "nodes": [
            ...
            {"id": "watchlist", "type": "WatchlistNode", "category": "symbol", "symbols": [{"exchange": "NASDAQ", "symbol": "AAPL"}, {"exchange": "NASDAQ", "symbol": "MSFT"}, {"exchange": "NASDAQ", "symbol": "GOOGL"}], "position": {"x": 600, "y": 100}},
