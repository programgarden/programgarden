...
def get_workflow():
    return {
        ...
        "nodes": [
            ...
            {"id": "watchlist", "type": "WatchlistNode", "category": "symbol", "symbols": [{"exchange": "NASDAQ", "symbol": "AAPL"}], "position": {"x": 600, "y": 100}},
        ...
        "edges": [
            ...
            {"from": "order", "to": "recoveryHandler"},
            {"from": "broker", "to": "snapshotEvent"},
