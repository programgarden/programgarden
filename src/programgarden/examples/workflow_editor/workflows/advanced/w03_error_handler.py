...
def get_workflow():
    return {
        ...
        "nodes": [
            ...
            {"id": "watchlist", "type": "WatchlistNode", "category": "symbol", "symbols": [{"exchange": "NASDAQ", "symbol": "AAPL"}], "position": {"x": 600, "y": 200}},
        ...
        "edges": [
            ...
            {"from": "order", "to": "errorHandler"},
            {"from": "errorHandler", "to": "order"},
            {"from": "errorHandler", "to": "alert"},
