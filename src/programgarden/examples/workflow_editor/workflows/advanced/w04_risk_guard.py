...
def get_workflow():
    return {
        ...
        "nodes": [
            ...
            {"id": "watchlist", "type": "WatchlistNode", "category": "symbol", "symbols": [{"exchange": "NASDAQ", "symbol": "AAPL"}], "position": {"x": 600, "y": 150}},
        ...
        "edges": [
            ...
            {"from": "riskGuard", "to": "order"},
            {"from": "riskGuard", "to": "riskAlert"},
