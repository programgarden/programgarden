...
def get_workflow():
    return {
        ...
        "edges": [
            ...
            {"from": "marketData.price", "to": "rsiCond.price_data"},
            {"from": "account.balance", "to": "positionSize.account_info"},
            {"from": "marketData.atr", "to": "positionSize.atr_data"},
            {"from": "rsiCond.passed_symbols", "to": "order.trigger"},
            {"from": "positionSize.quantity", "to": "order.quantity"},
