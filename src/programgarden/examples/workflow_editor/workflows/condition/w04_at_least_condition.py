...
def get_workflow():
    return {
        ...
        "nodes": [
            ...
            {"id": "schedule", "type": "ScheduleNode", "category": "trigger", "cron": "0 * * * *", "timezone": "America/New_York", "position": {"x": 350, "y": 200}},
            {"id": "watchlist", "type": "WatchlistNode", "category": "symbol", "symbols": [{"exchange": "NASDAQ", "symbol": "AAPL"}, {"exchange": "NASDAQ", "symbol": "GOOGL"}], "position": {"x": 350, "y": 350}},
            ...
            {"id": "volume", "type": "ConditionNode", "category": "condition", "plugin": "VolumeSpike", "fields": {"multiplier": 2}, "position": {"x": 750, "y": 300}},
            {"id": "atLeast2", "type": "LogicNode", "category": "condition", "operator": "at_least", "min_count": 2, "position": {"x": 950, "y": 200}},
