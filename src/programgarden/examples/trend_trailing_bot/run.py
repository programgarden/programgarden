"""
추세추종 + 스탑로스 자동매매 봇 (텔레그램 알림)

매수: TSMOM 60일 모멘텀 양수 종목 1주 시장가 매수
매도: 손익률 -5% 이하 시 전량 시장가 매도
...
def load_workflow() -> dict:
    ...
    # 텔레그램 봇 (하이픈 키: TELEGRAM-TOKEN, TELEGRAM-CHAT-ID)
...
async def main():
    print("=" * 50)
    print("  추세추종 + 스탑로스 자동매매 봇")
    print("  (TSMOM 매수 / -5% 손절 / 텔레그램 알림)")
    print("=" * 50)
    ...
    print(f"\n  감시 종목: {sym_list}")
    print(f"  스케줄: 5분마다 (평일 09:30-15:55 ET)")
    print(f"  매수: TSMOM 60일 모멘텀 양수 → 1주 시장가")
    print(f"  매도: 손익률 -5% 이하 → 전량 시장가")
    print(f"\n  Ctrl+C 로 종료\n")
