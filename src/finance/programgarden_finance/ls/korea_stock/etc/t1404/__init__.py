...
logger = logging.getLogger("programgarden.ls.korea_stock.etc.t1404")
from .blocks import (
    T1404InBlock,
    T1404OutBlock,
    T1404OutBlock1,
...
class TrT1404(TRRequestAbstract, OccursReqAbstract):
    ...
    def __init__(self, request_data: T1404Request):
        ...
        self._generic: GenericTR[T1404Response] = GenericTR[T1404Response](self.request_data, self._build_response, url=URLS.KOREA_STOCK_ETC_URL)
