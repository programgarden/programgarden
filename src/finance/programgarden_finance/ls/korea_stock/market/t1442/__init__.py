...
logger = logging.getLogger("programgarden.ls.korea_stock.market.t1442")
from .blocks import (
    T1442InBlock,
    T1442OutBlock,
    T1442OutBlock1,
...
class TrT1442(TRRequestAbstract, OccursReqAbstract):
    ...
    def __init__(self, request_data: T1442Request):
        ...
        self._generic: GenericTR[T1442Response] = GenericTR[T1442Response](self.request_data, self._build_response, url=URLS.KOREA_STOCK_MARKET_URL)
