...
import os
from programgarden_finance import LS, t8453
...
def test_req_t8453():
    ...
    # 삼성전자(005930) 1틱봉 최근 50건 조회
    m = ls.국내주식().차트().주식차트틱(
        t8453.T8453InBlock(shcode="005930", ncnt=1, qrycnt=50, sdate="20260228", edate="20260228", comp_yn="N")
    )
