...
import os
from programgarden_finance import LS, t1602
...
def test_req_t1602():
    ...
    # 코스피(1) 코스피전체(001) 수량(1) 당일(0) 조회
    m = ls.국내주식().투자자().시간대별투자자매매추이(
        t1602.T1602InBlock(market="1", upcode="001", gubun1="1", gubun2="0")
    )
